...
%
%     hem - Hemispheres to run. Can be 'L', 'R', or 'both.' Defaults to
%     'both'.
%
%     mappingtype - Specify the method used to map the volume to the surface.
%      Can be 'enclosing','trilinear', or 'ribbon-constrained' (defaults to
%      'ribbon-constrained' if none is specified).
%
%    space - Can be 'MNI' or '711-2B'. Volumes must be in MNI space to be
%     mapped to the surface; if '711-2B' is selected, the volume will be
%     registered to MNI space before mapping. Defaults to 'MNI'.
%
%
...
Lsurface = '/data/nil-external/mcl/workbench/fsaverage_LR32k/Conte69.L.midthickness.32k_fs_LR.surf.gii';
Lwhitesurface = '/data/nil-external/mcl/workbench/fsaverage_LR32k/Conte69.L.white.32k_fs_LR.surf.gii';
Lpialsurface = '/data/nil-external/mcl/workbench/fsaverage_LR32k/Conte69.L.pial.32k_fs_LR.surf.gii';
Rsurface = '/data/nil-external/mcl/workbench/fsaverage_LR32k/Conte69.R.midthickness.32k_fs_LR.surf.gii';
Rwhitesurface = '/data/nil-external/mcl/workbench/fsaverage_LR32k/Conte69.R.white.32k_fs_LR.surf.gii';
Rpialsurface = '/data/nil-external/mcl/workbench/fsaverage_LR32k/Conte69.R.pial.32k_fs_LR.surf.gii';
...
%where workbench is installed on the server
workbenchdir = '/data/nil-external/mcl/workbench/bin_rh_linux64/';
